...
void fstWriter::writeSolution(struct inputConfig cf, rk_func *f, int tdx,
  ...
  if (cf.ndim == 2) {
    ...
    int idx;
    group_id =
        H5Gcreate(file_id, "/Grid", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
    ...
    group_id =
        H5Gcreate(file_id, "/Solution", H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
    ...
    if (cf.rank == 0) {
      ...
      fprintf(xmf,
              "     <Topology TopologyType=\"2DSMesh\" NumberOfElements=\"%d "
              "%d\"/>\n",
              NY + 1, NX + 1);
      ...
      fprintf(xmf, "     <Attribute Name=\"Momentum\" AttributeType=\"Vector\" "
                   "Center=\"Cell\">\n");
      fprintf(xmf,
              "      <DataItem Dimensions=\"%d %d 2\" Function=\"JOIN($0,$1)\" "
              "ItemType=\"Function\">\n",
              NY, NX);
      fprintf(xmf,
              "       <DataItem Dimensions=\"%d %d\" NumberType=\"Float\" "
      ...
      fprintf(xmf, "     <Attribute Name=\"Energy\" AttributeType=\"Scalar\" "
                   "Center=\"Cell\">\n");
      fprintf(xmf,
              "       <DataItem Dimensions=\"%d %d\" NumberType=\"Float\" "
              "Precision=\"4\" Format=\"HDF\">\n",
      ...
      for (int var = 3; var < cf.nv; ++var) {
        fprintf(xmf,
                "     <Attribute Name=\"Density%02d\" AttributeType=\"Scalar\" "
                "Center=\"Cell\">\n",
                var - 2);
        fprintf(xmf,
                "       <DataItem Dimensions=\"%d %d\" NumberType=\"Float\" "
    ...
    if (cf.rank == 0) {
      ...
      fprintf(xmf, "   <Grid Name=\"mesh1\" GridType=\"Uniform\">\n");
      fprintf(xmf,
              "     <Topology TopologyType=\"3DSMesh\" NumberOfElements=\"%d "
              "%d %d\"/>\n",
              NZ + 1, NY + 1, NX + 1);
