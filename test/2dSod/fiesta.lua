...
restart_freq = 50000                  --Restart Write Interval
write_freq = 1000                     --Solution Write Interval
stat_freq = 100
...
function f(i,j,k,v)
    ...
    local xcenter = 0.0   -- x coordinate of expansion center
    local ycenter = 0.0   -- y coordinate of expansion center
    ...
    if rdist < 0.4 then
        ...
        if v==2 then return 2.5    end
        if v==3 then return 1.0    end
    else
        --ambient conditions
        if v==0 then return 0      end
        if v==1 then return 0      end
        if v==2 then return 0.25   end
        if v==3 then return 0.125  end
    end
end
